...
"test (Recurrence.Daily.Daily)": "C19661. Recurrence - free: Daily Never",
"test (Recurrence.Weekly.Weekly)": "C19662. Recurrence - free: Weekly Never",
"test (Recurrence.Monthly.Monthly)": "C19663. Recurrence - free: Monthly Never",
"test (Recurrence.Yearly.Yearly)": "C19664. Recurrence - free: Yearly Never",
"test (Recurrence.DragToSomeday.DragToSomeday)": "C19666. Recurrence - free: Drag to someday - all recurrences are removed",
"test (Recurrence.SomedayToRecurring.SomedayToRecurring)": "C19667. Recurrence - free: Edit from someday to be recurring",
"test (Recurrence.WeeklyPremium.WeeklyPremium)": "C19677. Recurrence - premium: Weekly: Repeat on multiple days",
"test (Recurrence.MonthlyPremium.MonthlyPremium)": "C19678. Recurrence - premium: Monthly: Repeat by day of the week",
"test (Recurrence.XDays.XDays)": "C19679. Recurrence - premium: Every X days, Y times",
"": "C19680. free user: see upsell screens",
"": "C19649. purchase scenarios: new registered user - buy from upsell",
"test (Sharing.DragBetweenSections.DragBetweenSections)": "C19668. sharing: Share task, accept on other side, Drag to tomorrow, upcoming, someday",
"test (Sharing.EditSharedTask.EditSharedTask)": "C19669. sharing: Share task, accept on other side, Add priority, notes, reminder, subtasks, files at once",
"test (Sharing.CreateSharedTask.CreateSharedTask)": "C19669. sharing: Share task, accept on other side",
"test (Sharing.Decline.Decline)": "C19670. sharing: Decline invitation",
"test (Sharing.Comment.Comment)": "C19671. sharing: make comments",
"test (ListSharing.AddTaskToSharedList.AddTaskToSharedList)": "C19640. List sharing: On a shared list - add task with priority, notes, subtasks, files, reminder",
"test (ListSharing.CompleteTask.CompleteTask)": "C19642. List sharing: Complete task on a shared list",
...
"test (ChangeDefaultFolder.ChangeDefaultFolder)": "C19676. Edit default folder: Set another folder as default (from settings), add task in ALL",
"test (Positioning.MainGrid.MainGrid)": "C19645. Cross platform positioning: Main grid - reorder - see that list order syncs",
"test (ListView.ListView)": "C19646. Cross platform positioning: List view - Reorder tasks in a specific folder",
"test (ListViewALL.ListViewALL)": "C19647. Cross platform positioning: List view - See that tasks are ordered in ALL",
"test (PriorityView.PriorityView)": "C17551. Cross platform positioning: Priority view - reorder tasks in a specific folder (also reorder between regular to starred)",
"test (DateView.DateView)": "C17552. Cross platform positioning: Date view - Reorder tasks in a specific folder (also reorder between sections)",
...
"test (Login.SignIn.SignIn)": "C19672. Install scenarios: login",
"test (Login.GooglePlus.GooglePlus)": "C19673. Install scenarios: login w/ google",
"test (Login.Facebook.Facebook)": "C19674. Install scenarios: login w/ FB (see that user pic. is taken)",
"test (Signup.SignUp)": "C19675. Install scenarios: register",
}
def get_info(testString):
    try:res = caseInfo[testString]
    except KeyError: res = testString
    return res